...
fun PayActivity( modifier: Modifier = Modifier){
    Column (
        ...
        MainSection(
            judulParam = "nama", isiParam = "Imam Dwi Yan Permana"
        )
        MainSection(
            judulParam = "Kelas", isiParam = "B"
        )
        MainSection(
            judulParam = "NIM", isiParam = "20220140086"
        )
        MainSection(
            judulParam = "Keterangan", isiParam = "hamil"
        )
    }
}
    ...
    Box(modifier = Modifier.fillMaxWidth().background(color = Color.Magenta)){
        Row (
            ...
            Box(contentAlignment = Alignment.BottomEnd){
                Image(
                    painter = painterResource(id = R.drawable.umyremove),
